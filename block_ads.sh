...
curl -sSfL --retry "$MAX_RETRIES" --retry-all-errors https://big.oisd.nl/domainswild2 | grep -vE '^\s*(#|$)' > oisd_small_domainswild2.txt || silent_error "Failed to download the domains list"
